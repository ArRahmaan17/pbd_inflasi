 <div class="aside-secondary d-flex flex-row-fluid">
     <div class="aside-workspace my-5 p-5" id="kt_aside_wordspace">
         <div class="d-flex h-100 flex-column">
             <div class="flex-column-fluid" data-kt-scroll="true" data-kt-scroll-activate="false"
                 ...
                 <div class="tab-content">
                     <div class="tab-pane fade active show" id="kt_aside_nav_tab_menu" role="tabpanel">
                         <div class="menu menu-column menu-fit menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold fs-6 px-6 my-5 my-lg-0"
                             ...
                             <h3 class="fw-bolder text-dark mb-10 mx-0">Menu Aplikasi</h3>
 ...
 <button
     class="btn btn-sm btn-icon bg-body btn-success btn-active-success position-absolute translate-middle start-100 end-0 bottom-0 shadow-sm d-none d-lg-flex active"
     data-kt-toggle="true" data-kt-toggle-target="body" data-kt-toggle-name="aside-minimize"
     data-kt-toggle-state="active" style="margin-bottom: 1.35rem">
     <span class="svg-icon svg-icon-2 rotate-180">
         <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
             <rect opacity="0.5" x="6" y="11" width="13" height="2" rx="1" fill="grey" />
             <path
